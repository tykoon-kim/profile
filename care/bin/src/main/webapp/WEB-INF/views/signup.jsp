...
%>
    ...
    <div class="container">
    		...
    		<form method="post" action="saveMember.do" name="userinput" id="userinput" >
	<div class="sign-up">
	<div class="info">
                <p class="label">이름</p>
	...
	<div class="info">
	   ...
	   <input class="insert" type="password" name="pw" id="pw"/>
	</div>
	<div class="info">
	...
	<div id="ss" class="info">
	   ...
	   <input id="sex" type="radio" name="gender" value="남자" class="radio" onclick="getGender(event);" /><label for="남자">남자</label><br/>
