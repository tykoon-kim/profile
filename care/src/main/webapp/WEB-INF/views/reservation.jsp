														...
														<div id="testimonial_slider" class="carousel slide"
															...
															<div class="item carousel-item active">
																<div class="img-box"
																	...
																	<img src='resources/images/sds/${reservation.sdsimg }'
																		alt="">
																</div>

															</div>
															<p class="overview">
																<b style="font-size: 40px;"> ${reservation.sdsname}</b>
															</p>
															<div class="read_more">
																<div class="center">
																	<a class="main_bt read_bt" href="javascript:void(0);"
																		onclick="openfullcalendarPopup('${reservation.sdsmemcode}')">예약하기</a>
																</div>
															</div>
														</div>
													</div>
