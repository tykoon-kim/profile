	...
	<div class="full_container">
      ...
      <div class="page-title">
         <div class="row gutters">
            ...
            <div id="connection-container" style="margin-left: 30px;">
            <input type="text" id="receiver-id" placeholder="상담사 방코드 입력!" />
            <button type="button" class="btn detail_button" id="connect-button">상담 연결!</button>
            <button id="showRoomCodeButton" class="btn navy_button" style="margin-bottom: 5px;">방 코드 확인</button>
            </div>
         </div>
      </div>
      <div class="row status" id="status" style=" margin-left: 1px;"></div>
      <!-- Page header end -->
