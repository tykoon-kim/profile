															...
															<div class="contact_blog">
																...
																<div class="contact_inner">
																	<div class="left" style="width: 70%;">
																		<h3 style="z-index: 100;">${support.supname }</h3>
																		<!--    <span class="gray-label">지원대상자 : ${support.supage }</span> -->
																		
																		<ul class="list-unstyled">
																		
																			<li style="margin-bottom: 20px;"><img class="img-support"
																			src="resources/images/icon/date.png" width="25px" height="25px" /><span class="span_bold"></span> 시행날짜 :
																				${support.supcheck }</li>
																			<li style="margin-bottom: 20px;"><img class="img-support"	
																			src="resources/images/icon/man.png" width="25px" height="25px" /><span class="span_bold"></span> 지원대상자 :
																				${support.supage }</li>
																			<li style="margin-bottom: 20px;"><img class="img-support"
																			src="resources/images/icon/content.png" width="25px" height="25px" /><span class="span_bold"></span> 정책내용 :
																				${support.supcontent }</li>
																		</ul>
																	</div>
																	<div class="right">
																		<div class="profile_contacts">
																			<img class="img-responsive" src=${support.suppoto }
																				alt="#" />
																		</div>
																	</div>
																</div>
																<div class="bottom_list">
																	<div class="right_button">
																		<button type="button" class="btn detail_button btn-xs"
																			onclick="window.open('${support.supurl }') ">
																			<i class="fa fa-user"> </i>정책보기
																		</button>
																	</div>
																</div>
															</div>
