...
<html lang="en">
	...
	<div class="full_container">
		<div class="inner_container">
            ...
            <div class="midde_cont">
                           ...
                           <div class="full inbox_inner_section">
                              <div class="row">
                                 ...
                                 <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12"
                                    style="margin-left: 25%; flex:12.5%; max-width:50%;">
                                    <div class="table_price full margin_top20px">
                                       <form action="updateDiary.do" method="post">
                                             ...
                                             <label class="form-label f_size24 ">
                                                작성 날짜 : <fmt:formatDate value="${diary.notedate}" pattern="yyyy년 MM월 dd일" /><!--오늘 날짜--><samp>, </samp>
                                          ...
                                          <div class="mb-3" style="margin: 1.5% 2%">
                                             ...
                                             <input name="notetitle" type="text" class="form-control f_size1_1rem" id="exampleFormControlInput1"
                                                placeholder="제목칸" value="${diary.notetitle}">
                                          </div>
                                          <div class="mb-3" style="margin: 1.5% 2%">
                                             <label for="exampleFormControlTextarea1"
                                                class="form-label f_size24">내용</label>
                                             <textarea name="notecontent" class="form-control f_size1_1rem" id="exampleFormControlTextarea1"
                                                rows="20">${diary.notecontent}</textarea>
                                          </div>
                                          ...
                                          <div class="left_alignment" style="margin-left: 2%">
                                             <div class="right_button">
                                                <a href="diary.do?memcode=${MemLogin}" class="btn btn-xs detail_button">목록보기</a>
                                             </div>
                                          </div>
                                       </form>
                                 </div>
               ...
               <div class="container-fluid">
                  <div class="footer">
                     <p>Copyright ©2023 Designed by html.design. All rights reserved.</p>
                  </div>
               </div>
            </div>
            <!-- end dashboard inner -->
   ...
   function clickInform() {	/*삭제 확인 알림*/
	 ...
	 function diaryDeletion() {	/*실제삭제*/
		 location.href='deleteDiary.do?notecode=${diary.notecode}&memcode=${diary.memcode}';
	 }
