                                       ...
                                       <div class="contact_blog">
                                          ...
                                          <div class="contact_inner">
                                             <div class="left">
                                                ...
                                                <li style="margin-bottom: 10px;"><span class="span_bold">분류</span> : ${fair.faircate }</li>
                                                   <li style="margin-bottom: 10px;"><span class="span_bold">시작날짜</span> : ${fair.fairstart }</li>
                                                   <li style="margin-bottom: 10px;"><span class="span_bold">종료날짜</span> : ${fair.fairend }</li>
                                                   <li style="margin-bottom: 10px;"><span class="span_bold">주소</span> : ${fair.fairaddr }</li>
                                                </ul>
                                             </div>
                                             <div class="right">
                                             ...
                                             <div class="bottom_list">
                                                <div class="right_button">
                                                   <button type="button" class="btn detail_button btn-xs" onclick="window.open('${fair.fairurl }') ">
