			...
			<div id="content">
								...
								<div class="white_shd full margin_bottom_30">
									<div class="full graph_head">
										<div class="heading1 margin_0">
											<h2>
												의사소통훈련
												<button id="infoButton" class="custom-button navy_button">의사소통훈련이란</button>
											</h2>
														...
														<aside class="lg-side">
															<div class="chat-container">
																<div class="chat-header">
																	<h1>친구와 대화를 시작해보세요.</h1>
																	<div class="chat-intro">

																		<p>업무 대화나 일상 대화 문제를 풀어보고 싶다면</p>
																		<p>
																			'<strong>업무대화 문제풀고싶어</strong>' 또는 '<strong>일상대화
																				문제풀고싶어</strong>'
																		</p>
																		<p>
																			입력해보세요.
				...
				<div id="infoPopup" class="popup">
					<div class="popup-content">
						...
						<p>
							<strong>대화를 통해 자신의 생각과 의견을 명확하게 표현하는 방법을 배우며,</strong><br />더
							다양한 주제로 대화하면서 <strong>소통 능력을 향상시킬 수 있습니다.</strong><br /> <strong>의사소통
								능력은 업무와 일상 생활에서 모두 중요하며,</strong><br />유스브릿지 봇을 통한 대화가 그 <strong>시작점이
								될 것입니다.</strong>
						</p>
					</div>
				</div>
