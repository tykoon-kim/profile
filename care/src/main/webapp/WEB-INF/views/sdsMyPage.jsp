                           ...
                           <div class="full inbox_inner_section">
                              <div class="row">
                                 ...
                                 <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12"
                                    ...
                                    <div id="button_ce">
                                       <button class="bubbly-button"><a style="text-decoration: none; color: white" href="javascript:void(0);"
                                 onclick="sdspopup('${sdsmemLogin}')">상담 예약 일정</a></button>
                                       <button class="bubbly-button">내 자격증</button>
                                       <button class="bubbly-button"><a style="text-decoration: none; color: white" href="getAllFreeBoards.do">내가 쓴 글 보기</a></button>
                                    </div>
                                    ...
                                    <div class="table_price full margin_top20px">
                                       <c:forEach items="${ sdsList }" var="sl">
                                          <form style="padding: 3.5% 3.5% 0 3.5%;">
                                             <h1 style="margin-bottom: 10px;">${ sl.sdsnick }님회원정보</h1>
                                             <div class="row mb-3">
                                                <div class="col-md-6">
                                                   <label for="inputEmail4" class="form-label f_size20">아이디</label>
                                                   <input type="email" class="form-control"
                                                      id="inputEmail4" name="sdsid" value="${ sl.sdsid }"
                                                      disabled>
                                                </div>
                                                <div class="col-md-6">
                                                   <label for="inputPassword4" class="form-label f_size20">비밀번호</label>
                                                   <input type="password" class="form-control" name="sdspw"
                                                      id="inputPassword4" value="${ sl.sdspw }">
                                                </div>

                                                <div class="col-12" style="margin-top: 10px;">
                                                   <label for="inputdate" class="form-label f_size20">가입날짜</label>
                                                   <input type="text" class="form-control" id="inputdate" name="sdsdate"
                                                      placeholder="${ sl.sdsdate }" disabled>
                                                </div>

                                                <div class="col-12" style="margin-top: 10px;">
                                                   <label for="inputname" class="form-label f_size20">이름</label>
                                                   <input type="text" class="form-control" id="inputname"
                                                      name="sdsname" placeholder="${ sl.sdsname }">
                                                </div>
                                                <div class="col-12" style="margin-top: 10px;">
                                                   <label for="inputname2" class="form-label f_size20">닉네임
                                                   </label> <input type="text" class="form-control" name="sdsnick"
                                                      id="inputname2" placeholder="${ sl.sdsnick  }">
                                                </div>
                                                <div class="col-12" style="margin-top: 10px;">
                                                   <label for="inputsdstel" class="form-label f_size20">자격증 번호
                                                   </label> <input type="text" class="form-control" name="sdscard"
                                                      id="inputsdstel" placeholder="${ sl.sdscard }">
                                                </div>
                                                <div class="col-12" style="margin-top: 10px;">
                                                   <label for="inputsdstel" class="form-label f_size20">전화번호
                                                   </label> <input type="text" class="form-control" name="sdstel"
                                                      id="inputsdstel" placeholder="${ sl.sdstel }">
                                                </div>
                                                <div class="col-12" style="margin-top: 10px;">
                                                   <label for="inputadd" class="form-label f_size20">주소
                                                   </label> <input type="text" class="form-control" id="inputadd"
                                                      name="sdsaddr" placeholder="${ sl.sdsaddr }">
                                                </div>
                                             </div>
                                             ...
                                             <fieldset class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                   <div class="form-check left_alignment"
                                                      ...
                                                      <input type="hidden" id="genderInput" name="sdssex" value="${ sl.sdssex }" disabled />
                                       ...
                                       <div class="right_alignment"
                                          ...
                                          <form action="sdsmemupdate.do">
                                             <input type="hidden" name="sdsid" onclick="popup()"
                                                value="${ sl.sdsid }" /><input type="submit"
                                                class="btn navy_button left_alignment"
         ...
         <div class="modal-dialog">
            <div class="modal-content">
               ...
               <div class="modal-body">
                  <form action="sdsmemberDelete.do">
