										...
										<div class="row">
											<div class="col-md-12">
												<div class="full padding_infor_info"
													style="padding: 35px 35px 0px 35px;">
													<div class="table_row">
														<div class="table-responsive">
															<table class="table table-striped" id="table_center">
																<thead>
																	...
																	<tr class="th_tr">
																		<th></th>
																		<th><select id="goo" name="reggooname"
																			class="sr-select left_alignment" onchange="remove()"
																			style="width: 140px;">
																				<option value="선택" selected>선택하세요</option>
																				<c:forEach items="${gooList}" var="reggoo">
																					<option value="${reggoo.reggooname}">${reggoo.reggooname}</option>
																				</c:forEach>
																		</select></th>
																		<th><select id="dong" name="regdongname"
																			class="sr-select" style="width: 140px;">
																				<option value="선택" selected>선택하세요</option>
																		</select></th>
																		<th>
																			<div class="left_alignment">
																				<div class="right_button">
																					<button type="button"
																						...
																						onclick="searchStores()" style="margin-bottom: 3px;">검색하기</button>
																				</div>
																			</div>
																		</th>
																		<th></th>
												...
												<div class="full padding_infor_info"
													style="padding: 15px 35px 35px 35px">
													<div class="mail-box">
