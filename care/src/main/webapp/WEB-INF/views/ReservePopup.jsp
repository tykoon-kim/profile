...
<body>
	...
	<div class="group" id="popupGroup">
		<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12"
			...
			<div class="table_price full margin_top20px" style="padding-bottom:25px;">
				<%--  <c:forEach items="${ myList }" var="mem"> --%>
				<form id = "scheduleData" method="post" action="insertReserve.do" style="padding: 3.5% 3.5% 0 3.5%;">
					...
					<fieldset class="row mb-3">
						...
						<div class="col-sm-10">
							<div class="form-check radio2" style="margin-right: 30px; ">
								<input class="form-check-input" type="radio" name="mccate1" id="genderInput" value="대인관계 문제 해결" onclick="getCate(event);" style="accent-color:#426080;" checked>
								<label class="form-check-label" for="genderInput" > 대인관계 문제 해결 </label>
							</div>
							<div class="form-check radio2" style="margin-right: 30px;">
								<input type="hidden" id="" name="genderInput1" value="" disabled />
								<input class="form-check-input" type="radio" name="mccate1" id="genderInput1" value="스트레스와 불안" onclick="getCate(event);" style="accent-color:#426080;">
								<label class="form-check-label" for="genderInput1"> 스트레스와 불안 </label>
							</div>
							<div class="form-check radio2" style="margin-right: 30px;">
								<input type="hidden" id="" name="genderInput2" value="" disabled />
								<input class="form-check-input" type="radio" name="mccate1" id="genderInput2" value="진로에 대한 고민" onclick="getCate(event);" style="accent-color:#426080;">
								<label class="form-check-label" for="genderInput2"> 진로에 대한 고민 </label>
							</div>
							<div class="form-check radio2" style="margin-right: 30px;">
								<input type="hidden" id="" name="genderInput3" value="" disabled />
								<input class="form-check-input" type="radio" name="mccate1" id="genderInput3" value="자존감 하락" onclick="getCate(event);" style="accent-color:#426080;">
								<label class="form-check-label" for="genderInput3"> 자존감 하락 </label>
							</div>
						</div>
					</fieldset>
					...
					<div class="row mb-3" style="margin-bottom: 0rem!important;">
						<div class="col-md-6">
							...
							<input type="text" class="form-control existing-end-dates" id="datetimepicker" value=""
								autocomplete="off" name="startdate" type="text">
					...
					<div class="row mb-3" style="margin-bottom: 0rem!important;">
						<div class="col-md-6">
							...
							<input type="text" class="form-control existing-end-dates" id="datetimepicker1"
								autocomplete="off" name="enddate" type="text">
						</div>
					</div>
