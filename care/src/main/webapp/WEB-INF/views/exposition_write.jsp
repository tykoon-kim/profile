									...
									<div class="full inbox_inner_section">
										<div class="row">
											...
											<div class="col-lg-3 col-md-6 col-sm-6"
												style="margin-left: 25%; flex: 15%; max-width: 50%;">
												<div class="table_price full margin_top20px">
													<form>
														<div class="mb-3" style="margin: 3% 2%;">
															<label for="exampleFormControlInput1"
																class="form-label f_size24">박람회명</label> <input
																type="text" class="aaa" id="exampleFormControlInput1"
																placeholder="박람회명작성">
														</div>
														<div class="mb-3" style="margin: 3% 2%;">
															<label for="exampleFormControlInput1"
																class="form-label f_size24">분류</label>
															<div action="#" class="position search_inbox"
																style="margin-bottom: 4%;">
																<div class="input-append">
																	<select name="" class="sr-select aaa"
																		style="border: 1px solid #898989; margin-bottom: 18px;">
																		<option>취업</option>
																		<option>전시</option>
																		<option>문화</option>
																		<option>기타</option>
														...
														<div class="mb-3" style="margin: 3% 2%;">
															...
															<label for="exampleFormControlInput3"
																class="form-label f_size24" style="display: block;">기간</label>
															<div class="left_alignment"
																style="width: 50%; margin-bottom: 3%;">
																시작일 <input type="date" class="bbb" name="birthday">
															</div>
															<div class="right_alignment"
																style="width: 50%; margin-bottom: 3%;">
																마감일 <input type="date" class="bbb " name="birthday">
															</div>

														</div>
														<div class="mb-3" style="margin: 3% 2%;">
															<label for="exampleFormControlInput3"
																class="form-label f_size24">페이지경로</label> <input
																type="url" class="aaa" id="exampleFormControlInput3"
																placeholder="페이지경로">
														</div>

														<div class="mb-3" style="margin: 3% 2%;">
															<label class="form-label f_size24">파일</label>
															<div class="file-upload">
																<div class="file-select">
																	<div class="file-select-button" id="fileName">파일
																		선택</div>
																	<div class="file-select-name" id="noFile">파일이
																		없습니다</div>
														...
														<div class="mb-3" style="margin: 3% 2%;">
															<div class="right_alignment">
																<div class="right_button">
																	<a class="btn btn-xs detail_button">박람회 작성</a>
																</div>
															</div>
															<div class="left_alignment">
																<div class="right_button">
