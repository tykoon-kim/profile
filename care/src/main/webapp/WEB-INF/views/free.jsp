					...
					<div class="container-fluid">
					    ...
					    <div class="row justify-content-start">
					        <div class="col-md-3 d-flex align-items-start">
					            <form action="searchFreeBoards.do" method="get" class="d-flex align-items-start">
					                <select name="searchCondition" class="form-select me-1" style="width: 150px;">
									    <option value="freetitle">제목</option>
									    <option value="freecode">글번호</option>
									    <option value="nick">작성자</option>
									</select>
					                <input type="text" name="searchKeyword" class="form-control me-2" placeholder="검색어를 입력하세요" aria-label="검색어" aria-describedby="search-button" style="flex: 1 0 auto; margin-right: -10px;">
					                <button class="btn detail_button" type="submit" id="search-button" style="flex: 0 0 auto;">검색</button>
					            </form>
					        </div>
					    </div>
					    
					   <!-- Table section -->
					    <div class="table_section mt-4">
					        <table class="table table-bordered table-striped text-center">
					            <thead>
					                <tr>
					                    <th class="fw-bold">글번호</th>
					                    <th class="fw-bold">제목</th>
					                    <th class="fw-bold">작성자</th>
					            ...
					            <tbody>
					                <c:forEach items="${freeBoards}" var="freeBoard">
					                    <tr>
					                        <td>${freeBoard.freecode}</td>
					                        <td class="text-center">
					                            <a href="getFreeBoard.do?freecode=${freeBoard.freecode}&memcode=${freeBoard.member.memcode}" class="text-decoration-none">${freeBoard.freetitle}</a>
					                        </td>
					                        <td>${freeBoard.member.nick}</td> 
					                        <td><fmt:formatDate value="${freeBoard.freedate}" pattern="yyyy-MM-dd"/></td>
					                    </tr>
					                </c:forEach>
					            </tbody>
					        </table>
					        ...
					        <div class="col-md-9">
					            <div class="text-end">
					                <c:if test="${not empty Login}">
					                    <a href="freeinsert.do?memcode=${MemLogin}" class="btn detail_button" >글 작성하기</a>
					                </c:if>
					            </div>
					        </div>
					    </div>
