...
//*****************************************************************************
var question1 = {
                  question: "호감을 얻는 자세로 틀린 것은?",
                  answers: ["공평하게 대화하기", "긍정적으로 대화하기", "겸손하게 대화하기", "비밀 없이 대화하기"],
                  correct: 3
                };
...
var question3 = {
                  question: '회사 호칭으로 옳은 것은?',
                  answers: ['태경아', '성요씨', '성민언니', '택훈오빠'],
                  correct: 1
                }

var question4 = {
                  question: "회사 대화방법으로 틀린 것은?",
                  answers: ["듣는 연습하기", "친절하고 예의있게 행동하기", "자신감 갖기", '눈을 회피하며 대화하기'],
                  correct: 3
                };

var question5 = {
                  question: "의사소통 오류의 원인이 아닌 것은?",
                  answers: ["부족한 팀 케미스트리", "적극적인 경청자세", "잘못된 채널 선택", "투명성 부족"],
                  correct: 1
                };

var question6 = {
                  question: "직장을 위한 대화 전략이 아닌 것은?",
                  answers: ["직원들과 정기적인 만남", "성취 인정", "닫힌 환경 만들기","피드백에 개방적"],
                  correct: 2
                };
...
function showResults () {
  ...
  if (correctAns >= 5) {
    ...
    var textCongrats = document.createTextNode('축하합니다! 정말 훌륭하시네요!')
